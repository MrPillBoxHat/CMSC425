...
static const enum states {STAND, RUN, JUMP, JUMP_OUT, FIRE, CHARGE, DASH, DAMAGE, DIE_STATE, ENTRY, SABER, SABER_MISSILE, SLIDE};
static const enum texture_states{STAND_RIGHT, STAND_LEFT, RUN_LEFT, RUN_RIGHT, JUMP_LEFT, JUMP_RIGHT,
								...
								DIE, ENTRY_TEXUTRE, JUMP_FIRE_RIGHT, JUMP_FIRE_LEFT,
								HEALTH_BAR, HEALTH_BLOCK, SLIDE_LEFT, SLIDE_RIGHT, SABER_RIGHT, SABER_LEFT, CHARGE_TEXTURE};

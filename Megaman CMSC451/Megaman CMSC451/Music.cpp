...
Music::Music()
{
    ...
    fp=fopen("Music/credits.wav","rb");                                            //Open the WAVE file
    if (!fp) endWithError("Failed to open file");								//Could not open file
	
	//Loading of the WAVE file
    FILE *fp2 = NULL;                                                            //Create FILE pointer for the WAVE file
    fp2=fopen("Music/Boss.wav","rb");                                            //Open the WAVE file
    if (!fp2) endWithError("Failed to open file");								//Could not open file

	//Loading of the WAVE file
    FILE *fp3 = NULL;                                                            //Create FILE pointer for the WAVE file
    fp3=fopen("Music/Game_Over.wav","rb");                                            //Open the WAVE file
    if (!fp3) endWithError("Failed to open file");								//Could not open file

	//Loading of the WAVE file
    FILE *fp4 = NULL;                                                            //Create FILE pointer for the WAVE file
    fp4=fopen("Music/Boss.wav","rb");                                            //Open the WAVE file
    if (!fp4) endWithError("Failed to open file");								//Could not open file

	//Loading of the WAVE file
    FILE *fp5 = NULL;                                                            //Create FILE pointer for the WAVE file
    fp5=fopen("Music/Boss.wav","rb");                                            //Open the WAVE file
    if (!fp5) endWithError("Failed to open file");								//Could not open file

	//Loading of the WAVE file
    FILE *fp = NULL;                                                            //Create FILE pointer for the WAVE file
    fp=fopen("Music/Boss.wav","rb");                                            //Open the WAVE file
    if (!fp) endWithError("Failed to open file");								//Could not open file
    ...
    if(!format) endWithError("Wrong BitPerSample");                      //Not valid format
...
void Music::endWithError(char* msg)
{
